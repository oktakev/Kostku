	...
	<div class="page-content pt-0">
		...
		<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
									<form action="<?php echo base_url(). 'admin/fasilitas/update'; ?>" method="post">
									<fieldset>
										...
										<div class="collapse show" id="demo1">
											<div class="form-group">
												...
												<input type="hidden" name="fasilitas_id" value="<?php echo $u->fasilitas_id ?>">
												<input 
													type="text" 
													name="nama_fasilitas" 
													class="form-control" 
													placeholder="Nama Fasilitas"
													value="<?php echo $u->nama_fasilitas ?>">
											</div>
										</div>
									</fieldset>
