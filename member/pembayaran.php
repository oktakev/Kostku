<?php
	...
	$query = "SELECT pembayaran.bayar_id,data_penghuni.nama_lengkap,kamar.no_kamar,pengaturan_biaya.biaya,pembayaran.periode,pembayaran.tanggal_bayar from pembayaran JOIN data_penghuni ON pembayaran.bayar_id = data_penghuni.data_penghuni_id JOIN kamar ON pembayaran.data_kamar_id = kamar.data_kamar_id JOIN pengaturan_biaya ON pembayaran.biaya_kost_id = pengaturan_biaya.biaya_kost_id";
